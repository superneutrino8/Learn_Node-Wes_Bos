...
function typeAhead(search) {
  ...
  searchInput.on("input", function () {
    ...
    axios__WEBPACK_IMPORTED_MODULE_0___default.a.get("/api/search/?q=".concat(this.value)).then(function (res) {
      if (res.data.length) {
        searchResult.innerHTML = dompurify__WEBPACK_IMPORTED_MODULE_1___default.a.sanitize(searchResultHTML(res.data));
        return;
      }

      searchResult.innerHTML = dompurify__WEBPACK_IMPORTED_MODULE_1___default.a.sanitize("<div class=\"search__result\">No results for ".concat(_this.value, "</div>"));
